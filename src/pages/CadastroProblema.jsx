...
export default function CadastroProblema() {
  return (
    <div className="w-full min-h-screen flex justify-center bg-[#f5f7fb] py-10">
      <div className="w-[850px] bg-white p-10 rounded-2xl shadow-lg">
        {/* NAV */}
        ...
        <div className="flex justify-center mb-8">
          <button className="w-28 h-28 rounded-full bg-[#6fa8ff] flex items-center justify-center cursor-pointer">
            <FiCamera size={38} color="#fff" />
          </button>
        </div>
